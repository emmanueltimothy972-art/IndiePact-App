...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: "Contract Intelligence",                 included: false },
      { text: "Negotiation War Room",                 included: false },
      { text: "Payment Lock",                         included: false },
      { text: "Contract Strategy",                    included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Contract Intelligence",               included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Contract Strategy",                   included: true },
...
const PAY_PER_SCAN_FEATURES = [
  ...
  "Contract Intelligence — clause-by-clause risk analysis",
  "Contract Strategy",
  "Payment Lock",
  "Export to PDF",
];
